...
INSERT INTO producao.Produto(cd_linha_producao, aa_producao, cd_tipo_produto) 
			    VALUES
			    ( 1, 22, 1)
			  , ( 1, 22, 1)	   
			  , ( 2, 22, 1)
...
INSERT INTO producao.Inspecao(cd_ficha, cd_produto, linha_produto, aa_produto, sg_avaliacao, hr_inspecao) 
			     VALUES 
			     ( 1, 1, 1, 22, 'OK', '09:03')
			   , ( 1, 3, 1, 22, 'OK', '09:36')
			   , ( 1, 5, 1, 22, 'EL', '10:05')
